...
.w3-text-bold,.w3-bold {
    font-weight: bold
}

.w3-text-italic,.w3-italic {
    font-style: italic
}
...
.w3-asphalt,.w3-hover-asphalt:hover {
    color: #fff!important;
    background-color: #343a40!important
}

.w3-crimson,.w3-hover-crimson:hover {
    color: #fff!important;
    background-color: #a20025!important
}

.w3-cobalt,w3-hover-cobalt:hover {
    color: #fff!important;
    background-color: #0050ef!important
}

.w3-emerald,.w3-hover-emerald:hover {
    color: #fff!important;
    background-color: #008a00!important
}

.w3-olive,.w3-hover-olive:hover {
    color: #fff!important;
    background-color: #6d8764!important
}

.w3-paper,.w3-hover-paper:hover {
    color: #000!important;
    background-color: #f8f9fa!important
}

.w3-sienna,.w3-hover-sienna:hover {
    color: #fff!important;
    background-color: #a0522d!important
}

.w3-taupe,.w3-hover-taupe:hover {
    color: #fff!important;
...
.w3-border-pale-blue,.w3-hover-border-pale-blue:hover {
  ...
  <body>
    <!--yeh 1st wala section hy-->
    <div class="w3-bar w3-black w3-hide-small">
      <a href="#facebook" class="w3-bar-item w3-button" id="fa-facebook"><i class="fa-brands fa-facebook"></i></a>
      <a href="#instagram" class="w3-bar-item w3-button" id="fa-instagram"><i class="fa-brands fa-instagram"></i></a>
      <a href="#snapchat" class="w3-bar-item w3-button"><i class="fa-brands fa-snapchat"></i></a>
      <a href="#flicker" class="w3-bar-item w3-button"><i class="fa-brands fa-flickr"></i></a>
      <a href="#twitter" class="w3-bar-item w3-button" id="fa-twitter"><i class="fa-brands fa-twitter"></i></a>
      <a href="#linkdin" class="w3-bar-item w3-button"><i class="fa-brands fa-linkedin"></i></a>
      <a href="#search" class="w3-bar-item w3-button w3-right"><i class="fa fa-search"></i></a>
    </div>
    <!-- yeh 2nd wala section hy -->
    <div class="slider-container">
      <div class="slider-track">
        <header class="w3-container w3-center w3-padding-48 w3-white slide">
    ...
    <section class="w3-display-container w3-wide" id="home">
        ...
        <div class="w3-display-left w3-padding-large">
          ...
          <h6><button class="w3-button w3-white w3-padding-large w3-large w3-opacity w3-hover-opacity-off" id="Follow">SUBSCRIBE</button></h6>
        </div>
    </section>
    <!-- yeh 2nd last section hy! -->
    <section class="w3-row w3-padding w3-border">
        <div class="w3-col l8 s12">
          <div class="w3-container w3-white w3-margin w3-padding-large">
            ...
            <div class="w3-justify">
              <img src="2nd pro img.jpg" alt="Girl Hat" style="width:100%" class="w3-padding-16">
              ...
              <p class="w3-left"><button class="w3-button w3-white w3-border" onclick="likeFunction(this)" style="font-weight: bold;">✓ Liked</button></p>
              ...
              <div class="w3-row w3-margin-bottom" id="demo1" style="display:none">
                <hr>
                  <div class="w3-col l2 m3">
                    <img src="3rd pro image.jpg" style="width:90px;">
                  </div>
          ...
          <div class="w3-container w3-white w3-margin w3-padding-large">
            ...
            <div class="w3-justify">
              <img src="chupa.jpg" alt="Men in Hats" style="width:100%" class="w3-padding-16">
              ...
              <div id="demo2" style="display:none">
                <div class="w3-row">
                  <hr>
                  <div class="w3-col l2 m3">
                    <img src="amber.jpg" style="width:90px;">
                  </div>
                  <div class="w3-col l10 m9">
                ...
                <div class="w3-row w3-margin-bottom">
                  <div class="w3-col l2 m3">
                    <img src="angie.jpg" style="width:90px;">
                  </div>
                  <div class="w3-col l10 m9">
          ...
          <div class="w3-container w3-white w3-margin w3-padding-large">
            ...
            <div class="w3-justify">
              <img src="models.jpg" alt="Runway" style="width:100%" class="w3-padding-16">
              ...
              <div id="demo3" style="display:none">
                ...
                <div class="w3-row w3-margin-bottom">
                  <div class="w3-col l2 m3">
                    <img src="jane.jpg" style="width:90px;">
                  </div>
                  <div class="w3-col l10 m9">
                ...
                <div class="w3-row w3-margin-bottom">
                  <div class="w3-col l2 m3">
                    <img src="john.jpg" style="width:90px;">
                  </div>
                  <div class="w3-col l10 m9">
                ...
                <div class="w3-row w3-margin-bottom">
                  <div class="w3-col l2 m3">
                    <img src="anja.jpg" style="width:90px;">
                  </div>
                  <div class="w3-col l10 m9">
        ...
        <div class="w3-col l4">
          <div class="w3-white w3-margin">
            <img src="3rd pro image.jpg" alt="Jane" style="width:100%" class="w3-grayscale">
          ...
          <div class="w3-white w3-margin">
            ...
            <ul class="w3-ul w3-hoverable w3-white">
              <li class="w3-padding-16">
                <img src="denim.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                <span class="w3-large" id="hoverText">Denim</span>
                <br>
                <span id="popup">Sed mattis nunc</span>
              </li>
              <li class="w3-padding-16">
                <img src="sweaters.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                <span class="w3-large" id="hoverText">Sweaters</span>
                <br>
                <span id="popup">Praes tinci sed</span>
              </li>
              <li class="w3-padding-16">
                <img src="workshop.jpg" alt="Image" class="w3-left w3-margin-right" style="width:50px">
                <span class="w3-large" id="hoverText">Workshop</span>
                <br>
                <span id="popup">Ultricies congue</span>
              </li>
              <li class="w3-padding-16">
                <img src="trends.jpg" alt="Image" class="w3-left w3-margin-right w3-sepia" style="width:50px">
                <span class="w3-large" id="hoverText">Trends</span>
                <br>
                <span id="popup">Lorem ipsum dipsum</span>
              </li>
            </ul>
          </div>
          <hr>
          <div class="w3-white w3-margin">
            ...
            <div class="w3-container w3-white">
              <div class="w3-container w3-display-container w3-light-grey w3-section" style="height:200px" id="ads">
                <span class="w3-display-middle"></span>
              </div>
            </div>
          </div>
          <hr>
          <div class="w3-white w3-margin">
            ...
            <div class="w3-container w3-white">
              <p>
                <span class="w3-tag w3-black w3-margin-bottom"><a href="">Fashion</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">New York</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">London</a></span>
                <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Hats</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Norway</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Sweaters</a></span>
                <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Ideas</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Deals</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Accessories</a></span>
                <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">News</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Clothing</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Shopping</a></span>
                <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Jeans</a></span> <span class="w3-tag w3-light-grey w3-small w3-margin-bottom"><a href="">Trends</a></span>
              </p>
            </div>
          </div>
          <hr>
          <div class="w3-white w3-margin">
            ...
            <div class="w3-row-padding w3-white d-flex">
              <div class="w3-col s5">
                <p><img src="inspi 1.jpg" alt="Jeans" style="width:100%"></p>
                <p><img src="inspi2.jpg" alt="Jeans" style="width:100%"></p>
              </div>
              <div class="w3-col s5">
                <p><img src="inspi3.jpg" alt="Men in Hats" style="width:100%" class="w3-grayscale"></p>
                <p><img src="inspi4.jpg" alt="Jeans" style="width:100%"></p>
            </div>
            </div>
          </div>
          <hr>
          <div class="w3-white w3-margin">
            ...
            <div class="w3-container w3-xlarge w3-padding">
              <i class="fa-brands fa-facebook-official w3-hover-opacity" id="fafacebook"></i>
              <i class="fa-brands fa-instagram w3-hover-opacity" id="fainstagram"></i>
              <i class="fa-brands fa-snapchat w3-hover-opacity"></i>
              <i class="fa-brands fa-pinterest-p w3-hover-opacity"></i>
              <i class="fa-brands fa-twitter w3-hover-opacity" id="fatwitter"></i>
          ...
          <div class="w3-white w3-margin">
            ...
            <div class="w3-container w3-white">
              ...
              <p><button type="button" class="w3-button w3-block w3-red" id="Subscribe2">Submit</button></p>
            </div>
          </div>
        </div>
    </section>
    <!-- yeh last wala footer hy! -->
